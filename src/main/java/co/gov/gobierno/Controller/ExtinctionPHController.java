...
@ManagedBean
@ViewScoped
public class ExtinctionPHController implements Serializable
{
    private ThirdDTO objThirdDTO;
    private List<PropertieDTO> listPropertieDTOs;
    private static final org.slf4j.Logger log = LoggerFactory.getLogger(ExtinctionPHController.class);
    ...
    WebService ws;
    @EJB
    ExtinctionPHService ephs;
    
    public void Request()
    {
        try
        {
            String radNumber = ephs.GetRadicadoNumber(objThirdDTO, listPropertieDTOs, location, neightborhood);
            if(radNumber!=null && !radNumber.equals(""))
            {
                String expNumber = ephs.GetExpedientNumber(radNumber, listPropertieDTOs);
                if(expNumber!=null && !expNumber.equals(""))
                {
                    String appendNumber = ephs.AppendExpedient(radNumber, expNumber, listPropertieDTOs);
                    if(appendNumber!=null && !appendNumber.equals(""))
                    {
                        String responseFile1 = ephs.CreateAppend(radNumber, uploadConferenceRecord, listPropertieDTOs);
                        int counter=0;
                        ...
                        String responseFile2 = ephs.CreateAppend(radNumber, uploadAcceptDocument, listPropertieDTOs);
                        ...
                        String responseFile3 = ephs.CreateAppend(radNumber, uploadPublicDocument, listPropertieDTOs);
                        ...
                        String responseFile4 = ephs.CreateAppend(radNumber, uploadIdDocumentCopy, listPropertieDTOs);
                        ...
                        String responseFile5 = ephs.CreateAppend(radNumber, uploadCertificateOfTraditionAndFreedom, listPropertieDTOs);
                        ...
                        {
                            this.setAlertShow(true);
                            String emailResponse = EmailHandler.EnviarMensaje(this.objThirdDTO.getEmail(), "Solicitud de Extinción de Propiedad Horizontal",
