...
@ManagedBean
@ViewScoped
public class PHUpdateLegalAgentController implements Serializable
{

	private static final org.slf4j.Logger log = LoggerFactory.getLogger(PHUpdateLegalAgentController.class);
    ...
    @EJB
    PHUpdateLegalAgentService phula;
    ...
    public String updateLegalAgent()
    {
        ...
        try
        {
        	if (objThirdDTO.getListLegalAgentDTOs().size() <= 0) {
                ...
                this.setAlertMessage("Debe ingresar al menos un Representante.");
                return null;
        	}
        	//TODO:Modificar para que el metodo RegisterLegalAgent los datos los tome del arreglo de los representantes legales
            ...
            if (true)
            {
                ...
                if(radNumber!=null && !radNumber.equals(""))
                {
                    ...
                    if(appendNumber!=null && !appendNumber.equals(""))
                    {
                        ...
                        if(counter == 0)
                        {
                            WebServiceDTO objWebServiceDTOu = phula.updateLegalAgentPH(objThirdDTO, listPropertieDTOs,
                                    ...
                                    phoneLegalAgent, addressLegalAgent+addressComplLegalAgent, emailLegalAgent, localidadPropiedad, genderLegalAgent, idStatusLegalAgent,
                                    startAgent, endAgent, numberActAgent, dateActAgent, nameAgentJuridico, idNumberAgentJuridico, idTypeAgentJuridico,
                                    idTypeRepLegalAgent, razonSocialLegalAgent, typeDireccionLegalAgent);
                            if(objWebServiceDTOu.isRespuesta() && !objWebServiceDTOu.getXmlFile().isEmpty())
                            {
                                ...
                                parametros.put("tramite", "Actualización de de Representante Legal de Propiedad Horizontal");
                                ...
                                this.setModalAlertShow(true);
                                //String emailResponse = EmailHandler.EnviarMensaje(this.objThirdDTO.getEmail(), "Actualización de Representante Legal de Propiedad Horizontal",
                                //        "Estimado(a) Ciudadano(a) <br><br> Su solicitud de Actualizaci&oacute;n de Representante Legal de Propiedad Horizontal ha sido radicada exitosamente, su n&uacute;mero de radicado es el No " + radNumber + 
                                ...
                                //{
                                    ...
                                    this.setModalAlertStyle(true);
                                    this.setModalAlertMessage("Señor ciudadano su solicitud ha sido radicada exitosamente su" 
                                            + " número de radicado es el No " + radNumber + ", su solicitud será resuelta en un plazo maximo de 15 días hábiles");
                                    return "phconsultinit";
                                //}
                                //else
                                //{
                                //    this.setModalAlertStyle(false);
                                //    this.setModalAlertMessage("Error al enviar el email.");
                                //}
                            }
                        }
                    }
                    else
                    {
                        ...
                        this.setModalAlertShow(true);
                        this.setModalAlertStyle(false);
                        this.setModalAlertMessage("Ocurrió un error inesperado en el sistema contacte al administrador del sistema.");
                    }
                }
                else
                {
